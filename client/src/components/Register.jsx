  ...
  return (
    <div className='h-[calc(100vh - 120px)] flex justify-center items-center'>
      <div className='w-full max-w-sm mx-auto bg-white shadow-mdrounded px-8 mb-4 pt-6 pb-8'>
        ...
        <p className='align-baseline font-medium mt-4 text-sm'>Have an account ? Please sign in
        <Link to='/login' className="text-blue-500 hover:text-blue-700"><br/>Sign In</Link>
        </p>
